...
const updatedSessionsRecords = new mongoose.Schema({
  ...
  session_type: {
    type: String,
    enum: [ModelStrings.alternate, ModelStrings.weekdays,
    ModelStrings.weekends, ModelStrings.everyday],
  },
  fees: Number,
  paid_amount: Number,
  attended_by: {
...
const inactive_Appointments = new mongoose.Schema({
  user_info: {
    type: userInfoSchema,
    default: null
  },
...
const InActiveAppoinment = mongoose.model(
  "InActive_Appoinment",
  inactive_Appointments
);

module.exports = InActiveAppoinment;
